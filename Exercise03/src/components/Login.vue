        ...
        <div class="form-login">
            <div>
                <div style="height: 50%; display: flex;justify-content: center;align-items: center;">
                    <img src="../assets/user.png" style="height: 50%;border-radius:50%">
                </div>

                <form onsubmit="return false">
                    <label>Email</label>
                    <input type="text" name="" id="email" ref="email" placeholder=" Enter email" required>
                    <label>Password</label>
                    <input type="password" name="" id="password" ref="password" placeholder=" Enter password" required>
                    <button id="login" ref="login" @click="userLogin()">Login</button>
                    <div><p class="login-fail-message" ref="login_fail">Email or Password incorrect. Please try again</p></div>
                </form>
            </div>
